							...
							<div class="form-wrap">														
									<div class="container tab-content  ">                                     
										<div class="tab-content" data-content="signup">
											<h3>Đăng ký</h3>
											<form action="xulysignup.php" method="POST">
                                                ...
                                                <div class="col-md-12">
														...
														<input name="repassword" type="password" id="password" placeholder="Xác nhận lại mật khẩu..." class="form-control">
													</div>
												</div>
												
												<div class="row form-group">
                                                    <div class="col-md-12">
														<input name="signup" type="submit" class="btn btn-primary btn-block" value="Đăng Ký">
													</div>
												</div>
